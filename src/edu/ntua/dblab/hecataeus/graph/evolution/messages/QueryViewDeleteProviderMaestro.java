...
public class QueryViewDeleteProviderMaestro extends MaestroAbstract {
	public QueryViewDeleteProviderMaestro(final PriorityQueue<Message> q) {
		super(q);
	...
	/**
	 * @author pmanousi TODO: check to see if all attributes of output schema have
	 *         been deleted Actually this should happen in previous step (message
	 *         propagation but never mind).
	 */
	@Override
	String doRewrite(final Message msg,
		...
		final EvolutionNode inputNode = msg.toSchema;
