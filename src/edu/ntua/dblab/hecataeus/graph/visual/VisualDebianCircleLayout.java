...
public class VisualDebianCircleLayout extends VisualCircleLayout{
	...
	public void initialize() {
		...
		debianClusters();
		HecataeusViewer.vv.getRenderContext().setVertexFillPaintTransformer(new VisualClusteredNodeColor(HecataeusViewer.vv.getPickedVertexState()));
