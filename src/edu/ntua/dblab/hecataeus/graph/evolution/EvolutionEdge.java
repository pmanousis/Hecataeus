...
public class EvolutionEdge {
	...
	public boolean isPartOf() {
		if ((this.getType() == EdgeType.EDGE_TYPE_SCHEMA) || (this.getType() == EdgeType.EDGE_TYPE_SEMANTICS) ||
				(this.getType() == EdgeType.EDGE_TYPE_INPUT) || (this.getType() == EdgeType.EDGE_TYPE_OUTPUT) ||
