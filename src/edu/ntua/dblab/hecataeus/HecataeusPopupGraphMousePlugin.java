...
public class HecataeusPopupGraphMousePlugin extends EditingPopupGraphMousePlugin<VisualNode,VisualEdge>{
	...
	private JMenu getMenuCreateDirectedEdges(){
	...
	private AbstractAction getMenuDeleteNodes(){
	...
	private AbstractAction getMenuEditNode(){
	...
	private AbstractAction getMenuDeleteNode(){
	...
	private AbstractAction getMenuCreateNode(){
	...
	private AbstractAction getMenuDeleteEdge(){
	...
	private AbstractAction getMenuEditEdge(){
	...
	private AbstractAction getMenuAddPolicy(){
	...
	private AbstractAction getMenuAddEvent(){
	...
	private AbstractAction getMenuSetFrequency(){
	...
	private AbstractAction getMenuSetPolicies(){
	...
	private AbstractAction getMenuSetEvents(){
	...
	private AbstractAction getMenuShowModule(){
	...
	private AbstractAction getMenuSelectModule(){
	...
	private JMenu getMenuCreateMultipleEdges(){
