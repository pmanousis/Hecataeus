...
public class QueryViewDeleteAttributeMaestro<V extends EvolutionNode<E>,E extends EvolutionEdge> extends MaestroAbstract<V,E>
{
	public QueryViewDeleteAttributeMaestro(PriorityQueue<Message<V,E>> q)
	{
		super(q);
